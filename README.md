...
A shared pixel-art mailroom that fills the screen and that you walk around in. Jev is the mailroom’s little robot, and every visitor gets a little character of their own: walk with the arrow keys or WASD (or the on-screen pad and A button on touch screens, or by clicking where to go). Walk up to the **INCOMING** desk to leave Jev a short message, watch him carry the envelope to **Compliments, Feedback, Important, Big Ideas, Dad Jokes, Art, or Spam**, then walk up to a bin to read its messages. New visitors pick a name before walking in; Jev checks it, and it floats over their character as a name tag and signs the notes they send. Everyone in the room sees everyone else's character and name. The **Menu** button offers the same actions without walking. Screened-out messages get a visible toss into the trash; their contents stay private. There are no correction or recategorization controls.
